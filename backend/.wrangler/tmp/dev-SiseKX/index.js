...
var SYSTEM_PROMPT = `You are a helpful AI tutor. Keep responses brief (1-2 sentences).`;
var VoiceTeacherSession = class extends DurableObject {
  static {
    __name(this, "VoiceTeacherSession");
  }
  courseCode = "";
  history = [];
  isProcessing = false;
    ...
    try {
      ...
      if (ttsResult instanceof Uint8Array) {
        ...
        if (typeof audio === "string") {
          audioBuffer = Uint8Array.from(atob(audio), (c) => c.charCodeAt(0)).buffer;
        } else {
...
// .wrangler/tmp/bundle-9zuULA/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-9zuULA/middleware-loader.entry.ts
